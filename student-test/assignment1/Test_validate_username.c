...
void test_validate_my_username()
{
     ...
     */
    char username1[50]; // Assuming a maximum length for the username
    strcpy(username1, my_username());
    char *username2 = malloc_username_from_conf_file();
    TEST_ASSERT_TRUE_MESSAGE(strcmp(username1, username2) == 0, "Strings do not match");
    free(username2);
